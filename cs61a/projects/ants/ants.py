...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not next_place.is_hive:
            if self.min_range <= length <= self.max_range and next_place.bees:
